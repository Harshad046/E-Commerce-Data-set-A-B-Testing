...
### Register h4rsh 003 ilovemomo
> u1 is registering with the username "h4rsh", phone "003" and password as "ilovemomo"
-- --
...
```python 
python3 manage.py Register Harshad 8488 nawghareharshad@gmail.com ilovemomo
```